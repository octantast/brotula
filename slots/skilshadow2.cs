...
public class skilshadow2 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject slot1trigger;
    ...
    void Update()
    {
        ...
        if (slot1trigger == null)
        {
            slot1trigger = GameObject.Find("triggersvet1");
        }
        if (slot1trigger != null && slot1 == null)
        {
            slot1 = slot1trigger.transform.parent.gameObject;
        }
    ...
    private void OnTriggerStay2D(Collider2D other)
    {
       ...
       // }
        ...
        if (podsvetSkila.activeSelf == true && Input.touchCount > 0) // если этот навык двигается
        {
            ...
            if (other.name == "triggersvet1" || other.name == "triggersvet2" || other.name == "triggersvet3")
            {
                shadow.transform.localPosition = new Vector2(0f, 300f);
            }

            if (other.name == "triggersvet7" || other.name == "triggersvet8" || other.name == "triggersvet9")
            {
                shadow.transform.localPosition = new Vector2(0f, -300f);
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (podsvetSkila.activeSelf == true && Input.touchCount > 0 && slot1trigger.activeSelf == true) // если этот навык двигается
        {
            // принимает место слота, на который залезает
            if (other.name == "triggersvet1" || other.name == "triggersvet2" || other.name == "triggersvet3" || other.name == "triggersvet7" || other.name == "triggersvet8" || other.name == "triggersvet9")
            {
                shadownottransp.SetActive(false);
                shadow.transform.localPosition = shadowmotherplace;
            }
