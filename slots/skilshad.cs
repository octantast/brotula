...
public class skilshad : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D other)
    {
      ...
      //  }
        ...
        {
            if (other.CompareTag("Skill") && transform.localPosition.x != 0f) // не родительский
            {
    ...
    {
        if (other.CompareTag("kolonka") && transform.localPosition.y != 0f)
        {
