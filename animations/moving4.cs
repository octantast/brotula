...
public class moving4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        legpered.transform.localEulerAngles = new Vector3(0f, 0f, kolebanie * -0.8f);
        ...
        if (randommove == false)
        {
            ...
            armzad.transform.localEulerAngles = new Vector3(0f, 0f, elozit * 1.2f);
