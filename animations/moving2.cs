...
public class moving2 : MonoBehaviour
{
    ...
    {
        // вращение ног
        if (kolebanie < 4.1f && ziklnogi == false)
        {
            kolebanie += Time.deltaTime * 0.7f;
        }
        else
        {
            ziklnogi = true;
        }
        if (kolebanie > -4.1f && ziklnogi)
        {
        ...
        legpered.transform.localEulerAngles = new Vector3(0f, 0f, kolebanie * 0.7f);
        ...
        if (randommove == false)
        {
            ...
            armzad.transform.localEulerAngles = new Vector3(0f, 0f, elozit * 1.5f);
            armpered.transform.localEulerAngles = new Vector3(0f, 0f, elozit * -1f);
        }
